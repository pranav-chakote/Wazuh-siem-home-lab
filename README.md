...
The lab covers centralized log collection, endpoint monitoring, and File Integrity Monitoring (FIM). Wazuh detects file creation, modification, and deletion events in real time and surfaces them on the Wazuh Dashboard for security monitoring and investigation.
